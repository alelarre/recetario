...
| P79 | Probar el gesto del menú en Borradores | Se arregló recortando el título del borrador a dos renglones (`.bor .n`): sin recortar, uno largo —lo que trae Compartir: el texto de un reel, una URL— estiraba la página a lo ancho, y con scroll horizontal Android se quedaba con el deslizamiento. En el teléfono: deslizar para abrir el menú en Borradores, con un borrador de título largo en la lista, y que el título se vea cortado en dos renglones y no estire la pantalla. | Falta probar |
