...
| **P25** | **Reordenar y renombrar las fichas de Ajustes** | **Resuelto** `[2026-09-13]`. El orden es: 1. **Cuenta**; 2. **Índice**; 3. **Archivos locales** —antes «En este navegador» (P24)—; 4. **Avisos**; 5. **Registro de actividad** —antes «Al abrir» (P18)—. |
