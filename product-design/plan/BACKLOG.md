...
| **P16** | **Modo cocina: los controles del encabezado miden menos que los 64 px de §1** | `[2026-09-12]` Salió de la auditoría tipográfica (T14). §1 pide 64 × 64 px de área táctil en modo cocina; en el encabezado, el volver mide 48, y el sol de la pantalla encendida y *Salir*, 40. El sol llegó con P10: antes era una barra de 64 px al pie, y se achicó a 40 para alinearse con *Salir*. Resolverlo toca el alto del encabezado de cocina (56 px), que hoy no deja lugar a tres controles de 64. |
