...
| **P24** | **Borrar los datos locales desde Ajustes** | `[2026-09-13]` Un control en Ajustes que borre lo que la app guarda en el navegador —la copia local del índice y, cuando exista, el cache de imágenes de categorías (P19)— sin cerrar la sesión de Google. Es la salida para datos locales corruptos o viejos: la próxima apertura baja todo de Drive. Hoy lo más parecido es *Salir*, que además borra el token. |
