...
| **P23** | **Compartir recetas** | `[2026-09-13]` Poder compartir una receta con otra persona. Sin definir todavía: con quién —alguien que usa la app con su propio Drive, o cualquiera con un link—, qué se comparte —el `.md`, una copia, una vista— y si la receta queda enlazada o se copia. Se cruza con P15/P19: si otra persona usa la app con sus recetas, compartir es entre dos Recetarios. |
...
| **P25** | **Reordenar y renombrar las fichas de Ajustes** | `[2026-09-13]` El orden pasa a ser: 1. **Cuenta**; 2. **Índice**; 3. **Archivos locales** —hoy «En este navegador» (P24)—; 4. **Avisos**; 5. **Registro de actividad** —hoy «Al abrir» (P18)—. Hoy el orden es Cuenta, Índice, Al abrir, En este navegador, Avisos. |
