...
- [ ] **Sin fuente**, pide proponer la receta a partir del borrador y contrastarla con una búsqueda web de una o más fuentes, y poner en `fuente` la URL de la principal.
- [ ] No inventar temperaturas, tiempos ni cantidades que ninguna fuente respalde, ni agregar datos nutricionales.
